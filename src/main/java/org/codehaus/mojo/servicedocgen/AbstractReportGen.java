 ...
 * intermediate meta-data as {@link ServicesDescriptor}. Generates documentation from the collected meta-data.
 *
 * @author suvmanda
 *
 */
public abstract class AbstractReportGen extends AbstractMavenReport
{

    /**
     * The constructor.
     */
    public AbstractReportGen()
    {
    ...
    protected void executeReport(Locale locale) throws MavenReportException
    {
        ...
        try
        {
            ...
            Analyzer analyzer = new Analyzer( getLog(), this.project, getProjectClassloader(), builder, this.descriptor, this.introspectFields );
            ServicesDescriptor services = analyzer.createServicesDescriptor( serviceClasses );
            if ( getReportType() == ReportType.OPENAPI_JSON || getReportType() == ReportType.OPENAPI_YAML )
            {
            ...
            generator.generate( services, reportDirectory, getOutputName() );
